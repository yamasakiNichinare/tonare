...
<html lang="ja">
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
        ...
        <!-- Global site tag (gtag.js) - Google Ads: 812230876 -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-812230876"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());
                    ...
                    <main>
                        <section class="page">
                            ...
                            <div class="box__white box__complete">
                                <p>資料請求ありがとうございました。<br>なお、資料が届かない方、今後のご案内が不要の方は、大変お手数ですが弊所事務局までご連絡ください。</p>
                                <ul class="btns">
