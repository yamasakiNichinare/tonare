...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
    ...
    <meta property="og:title" content="東京ナレーション演技研究所">
    ...
    <meta property="og:site_name" content="東京ナレーション演技研究所">
    ...
    <title>《受講生専用》東ナレからのお知らせ | 東京ナレーション演技研究所</title>
            ...
            <div class="wall__inner">
                <main>
                    <section class="page box__cream">
                        ...
                        <div class="box box__white box__student">



                            <!--ここを書き換える-->
                            <div class="theInfoDetail">
                                <!--
                                <p>現在、お知らせはありません。</p>
                            -->
                            <section>
                                <h3>【新型コロナウイルス感染症の感染予防対策にともなう臨時休校についてのお知らせ】</h3>
                                <p>弊所のレッスンも年度の終盤を迎え、最終的なまとめの時期に入ってまいりました。しかしながら、すでに報道にあるように、全国の公立小中高校等が臨時の休校になるなど、感染拡大予防が急務の事態となりました。<br>そこで、弊所といたしましても諸般の事情を鑑み、本年度のレッスンを3月4日（水）をもって最終レッスンとさせていただき、3月6日（金）より臨時休校にさせていただくことといたしました。<br>受講生ならびに保護者の皆様におかれましては、何卒ご理解ご協力を賜りたく、お願い申し上げます。<br>なお、弊所事務局は通常どおり営業しておりますので、ご不明な点等ございましたらお問い合わせください。</p>
                            </section>
                            </div>
                            <!--ここを書き換える-->
                            ...
                            <ul class="btns">
                                <li class="button button--back backBtnWrap">
                ...
                <div class="sidebar forPC" id="sidebar">
                    <div class="sidebar__inner">
                        <aside class="asideTwitter">
                            <a class="twitter-timeline" data-lang="ja" data-chrome="noheader,nofooter" data-height="400" data-theme="dark" href="https://twitter.com/tonare_pr?ref_src=twsrc%5Etfw">Tweets by tonare_pr</a>
